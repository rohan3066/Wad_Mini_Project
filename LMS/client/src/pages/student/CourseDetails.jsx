    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Rohan Chavan</span>
          </p>

          <div className="pt-8 text-gray-800">
            <h2 className="text-xl font-semibold">Course Structure</h2>
            <div className="pt-5">
              {courseData.courseContent.map((chapter, indx) => (
                <div
                ...
                >
                  <div
                    ...
                    onClick={() => toggeSection(indx)}
                  >
                    <div className="flex items-center gap-2">
                      <img
                        className={`transform transition-transform ${
                          openSection[indx] ? "rotate-180" : ""
                        }`}
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ${
                      openSection[indx] ? "max-h-96" : "max-h-0"
                    }`}
                  >
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-red-500">
                {" "}
                <span className="font-medium"></span> 5 days Left at this price
              </p>
            </div>
